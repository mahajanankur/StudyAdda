...
import com.shivablast.studyadda.web.error.InvalidOldPasswordException;
import com.shivablast.studyadda.web.error.UserAlreadyExistException;
import com.shivablast.studyadda.web.error.UserNotFoundException;
import com.shivablast.studyadda.web.util.GenericResponse;
...
public class RegistrationController {
	...
	public GenericResponse changeUserPassword(final Locale locale,
		...
		final User user = userService.findUserByEmail(SecurityContextHolder
		...
		userService.changeUserPassword(user, password);
		return new GenericResponse(messages.getMessage(
				"message.updatePasswordSuc", null, locale));
	}
